                ...
                <div class="table-cell">
                        <div class="container">
                                ...
                                <div class="social-links">
                                        ...
                                        <a href="https://{{$social_links->facebook}}" target="_blank"
                                                class="facebook"><i class="bx bxl-facebook"></i></a>
                                        @endif

                                        @if ($social_links->instagram)
                                        <a href="https://{{$social_links->instagram}}" target="_blank"
                                                class="instagram"><i class="bx bxl-instagram"></i></a>
                                        @endif

                                        @if ($social_links->google_plus)
                                        <a href="https://{{$social_links->google_plus}}" target="_blank"
                                                class="google-plus"><i class='bx bxl-google-plus'></i></a>
                                        @endif

                                        @if ($social_links->linkedin)
                                        <a href="https://{{$social_links->linkedin}}" target="_blank"
